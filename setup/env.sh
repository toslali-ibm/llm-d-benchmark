...
# Temporary set to v0.2.1, until the current tag gets fixed
...
export LLMDBENCH_VLLM_MODELSERVICE_GAIE_PRESETS_CONTENT=${LLMDBENCH_VLLM_MODELSERVICE_GAIE_PRESETS_CONTENT:=""}
