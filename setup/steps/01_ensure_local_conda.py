...
def main():
    ...
    run_locally = ev.get("run_experiment_analyze_locally", "0") == "1"
    host_os = ev.get("control_deploy_host_os", "mac")
    host_shell = ev.get("control_deploy_host_shell", "bash")
    env_name = ev.get("harness_conda_env_name", "llmdbench-env")
