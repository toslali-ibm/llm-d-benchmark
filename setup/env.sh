...
export LLMDBENCH_VLLM_MODELSERVICE_CHART_VERSION=${LLMDBENCH_VLLM_MODELSERVICE_CHART_VERSION:-$(helm search repo llm-d-modelservice | tail -1 | awk '{print $2}' || true)}
