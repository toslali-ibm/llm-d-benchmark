...
# Prefill parameters
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_REPLICAS=__p_rep__
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_ACCELERATOR_NR=__p_tp__
...
# Decode parameters
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_REPLICAS=__d_rep__
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_ACCELERATOR_NR=__d_tp__
