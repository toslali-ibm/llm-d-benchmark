...
export LLMDBENCH_GATEWAY_API_CRD_REVISION="v1.2.0"
export LLMDBENCH_GATEWAY_API_INFERENCE_EXTENSION_CRD_REVISION="v0.5.1"
...
if [[ ! -z LLMDBENCH_VLLM_MODELSERVICE_GAIE_PRESETS ]]; then
